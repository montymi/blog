...
[![E2E Tests](https://github.com/suren-atoyan/react-pwa/actions/workflows/e2e.yml/badge.svg)](https://github.com/suren-atoyan/react-pwa/actions/workflows/e2e.yml)
...
- [e2e.yml](./.github/workflows/e2e.yml) - runs e2e tests on every push and pull request to `main/master` branch.
